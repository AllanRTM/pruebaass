...
namespace kielb.Controllers
{
    public class AccessController : Controller
    {
        ...
        //string urlDomain = "http://172.16.2.127:8992/";
        string urlDomain = "http://172.16.2.127:8992/";
        // GET: Access
        ...
        public ActionResult StartRecovery(Models.ViewModels.ClsRecoveryViewModel model)
        {
            try
            {
                ...
                var ouser = db.KB_UsuariosKielsaBonos.Where(d => d.email == model.email).FirstOrDefault();
                if (ouser != null)
                {
        ...
        public ActionResult Recovery(string token)
        {
            ...
            var ouser = db.KB_UsuariosKielsaBonos.Where(d => d.token_recovery == model.token).FirstOrDefault();
            if (ouser == null)
            {
